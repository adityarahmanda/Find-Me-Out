...
public class Packet : IDisposable
{
    ...
    {
        byte[] _objectByteArray = SerializeClass.ObjectToByteArray(_value); //serialize object and convert it to byte array
    ...
    public T ReadObject<T>(bool _moveReadPos = true)
    {
        try
        {
            ...
            return (T)SerializeClass.ByteArrayToObject(_objectByteArray); // Convert the byte array and return the object
        }
        catch
        {
